            ...
            <tbody>
                @foreach ($mirrorDungeons as $mirrorDungeon)
                    <tr>
                        ...
                        <td><img src="{{ asset($mirrorDungeon->getImagePath('yiSang')) }}" alt="{{ $mirrorDungeon->yiSang->Identity }}" title="{{ $mirrorDungeon->yiSang->Identity }}" class="identity-img {{ $mirrorDungeon->YiSangBenched ? 'benched' : '' }}"></td>
                        <td><img src="{{ asset($mirrorDungeon->getImagePath('faust')) }}" alt="{{ $mirrorDungeon->faust->Identity }}" title="{{ $mirrorDungeon->faust->Identity }}" class="identity-img {{ $mirrorDungeon->FaustBenched ? 'benched' : '' }}"></td>
                        <td><img src="{{ asset($mirrorDungeon->getImagePath('donQuixote')) }}" alt="{{ $mirrorDungeon->donQuixote->Identity }}" title="{{ $mirrorDungeon->donQuixote->Identity }}" class="identity-img {{ $mirrorDungeon->DonQuixoteBenched ? 'benched' : '' }}"></td>
                        <td><img src="{{ asset($mirrorDungeon->getImagePath('ryoshu')) }}" alt="{{ $mirrorDungeon->ryoshu->Identity }}" title="{{ $mirrorDungeon->ryoshu->Identity }}" class="identity-img {{ $mirrorDungeon->RyoshuBenched ? 'benched' : '' }}"></td>
                        <td><img src="{{ asset($mirrorDungeon->getImagePath('meursault')) }}" alt="{{ $mirrorDungeon->meursault->Identity }}" title="{{ $mirrorDungeon->meursault->Identity }}" class="identity-img {{ $mirrorDungeon->MeursaultBenched ? 'benched' : '' }}"></td>
                        <td><img src="{{ asset($mirrorDungeon->getImagePath('hongLu')) }}" alt="{{ $mirrorDungeon->hongLu->Identity }}" title="{{ $mirrorDungeon->hongLu->Identity }}" class="identity-img {{ $mirrorDungeon->HongLuBenched ? 'benched' : '' }}"></td>
                        <td><img src="{{ asset($mirrorDungeon->getImagePath('heathcliff')) }}" alt="{{ $mirrorDungeon->heathcliff->Identity }}" title="{{ $mirrorDungeon->heathcliff->Identity }}" class="identity-img {{ $mirrorDungeon->HeathcliffBenched ? 'benched' : '' }}"></td>
                        <td><img src="{{ asset($mirrorDungeon->getImagePath('ishmael')) }}" alt="{{ $mirrorDungeon->ishmael->Identity }}" title="{{ $mirrorDungeon->ishmael->Identity }}" class="identity-img {{ $mirrorDungeon->IshmaelBenched ? 'benched' : '' }}"></td>
                        <td><img src="{{ asset($mirrorDungeon->getImagePath('rodion')) }}" alt="{{ $mirrorDungeon->rodion->Identity }}" title="{{ $mirrorDungeon->rodion->Identity }}" class="identity-img {{ $mirrorDungeon->RodionBenched ? 'benched' : '' }}"></td>
                        <td><img src="{{ asset($mirrorDungeon->getImagePath('sinclair')) }}" alt="{{ $mirrorDungeon->sinclair->Identity }}" title="{{ $mirrorDungeon->sinclair->Identity }}" class="identity-img {{ $mirrorDungeon->SinclairBenched ? 'benched' : '' }}"></td>
                        <td><img src="{{ asset($mirrorDungeon->getImagePath('outis')) }}" alt="{{ $mirrorDungeon->outis->Identity }}" title="{{ $mirrorDungeon->outis->Identity }}" class="identity-img {{ $mirrorDungeon->OutisBenched ? 'benched' : '' }}"></td>
                        <td><img src="{{ asset($mirrorDungeon->getImagePath('gregor')) }}" alt="{{ $mirrorDungeon->gregor->Identity }}" title="{{ $mirrorDungeon->gregor->Identity }}" class="identity-img {{ $mirrorDungeon->GregorBenched ? 'benched' : '' }}"></td>
                    </tr>
                @endforeach
